        ...
        json.dumps(
            {
                ...
                "thresholds": {
                    ...
                    "min_reward_mean": 0.5,
                    "max_policy_rollout_q_l2": 1.0,
                    "max_policy_rollout_body_pos_l2": 0.1,
                    "min_policy_rollout_reward_mean": 0.5,
                },
...
def _write_playback_parity_report_without_policy_rollout_thresholds(tmp_path: Path) -> Path:
    report_path = tmp_path / "playback_parity_without_policy_rollout_thresholds.json"
    report_path.write_text(
        json.dumps(
            {
                "parity_passed": True,
...
def test_migration_audit_rejects_policy_rollout_report_without_threshold_evidence(tmp_path, capsys):
    audit = _load_audit_module()
    playback_report_path = _write_playback_parity_report_without_policy_rollout_thresholds(tmp_path)
